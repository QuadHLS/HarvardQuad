-- Fix: include squad chats in get_all_conversations (they were excluded by add_mute_conversations).
-- Recreates get_all_conversations without the squad exclusion.
