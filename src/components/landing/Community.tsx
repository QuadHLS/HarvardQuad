    ...
    <section className="pt-16 pb-40">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="space-y-14 mb-24">
          <blockquote className="border-l-4 border-neutral-300 pl-8 py-4">
          ...
          <blockquote className="flex gap-5 pl-0 py-4 items-end">
            <div className="w-36 h-36 flex-shrink-0 flex items-center justify-end">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1744 1744" fill="none" shapeRendering="auto" className="w-32 h-32" aria-hidden>
                ...
                <g transform="translate(396 278)" style={{ mixBlendMode: 'difference' }}>
