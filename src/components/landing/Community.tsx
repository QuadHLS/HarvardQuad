...
const CAPABILITIES = [
  {
    ...
    description: 'Open, restricted, and private Squads combine membership workflows, feeds, chat, and shared documents.',
  },
  {
    title: 'Realtime communication',
    description: 'Direct and group messaging support media, read state, pagination, mute and hide controls, and live updates.',
  },
  {
    title: 'Phone-specific workflows',
    description: 'Dedicated mobile navigation, touch drawers, safe-area layouts, and viewport handling adapt the shared React client.',
  },
] as const;
