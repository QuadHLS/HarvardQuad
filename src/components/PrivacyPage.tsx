...
Harvard Quad was paused before public launch. This older iOS branch contains implemented source, configuration templates, and an iOS wrapper; it is not a supported public service and does not intentionally include a database dump, private user-level content, production credentials, or test-account credentials.
